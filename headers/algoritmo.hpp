...
namespace CaminhoMinimo {
	...
	class Algoritmo {
	public:
		Algoritmo() : ptrGrafo(nullptr), distD(0.0), maxContagemK(0), passosT(0), tamGrafo(0), logN(0.0) {} // as variaveis são inicializadas em setGrafo já que elas dependem do tamanho do grafo.
